                ...
                <table className="employees-table">
                  ...
                  <tbody>
                    {employees.map((emp) => (
                      ...
                      >
                        <td className="emp-id">{getId(emp)}</td>
                        <td className="emp-name">{getName(emp)}</td>
                        <td className="emp-email">{getEmail(emp)}</td>
                        <td className="emp-dept">{getDept(emp)}</td>
                        <td className="emp-role">
                          {roleOptions.find((r) => r.id === String(emp?.role_id || emp?.roleId || "4"))?.label || "Employee"}
                        </td>
                        <td className="emp-phone">{emp?.phone || emp?.contact_number || emp?.contactNumber || "—"}</td>
                        <td className="emp-status">{getStatus(emp)}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
